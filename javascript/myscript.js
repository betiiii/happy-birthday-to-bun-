...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim đập đùng đùng " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Trái tim nhỏ bé này:';
document.querySelector('.Description .modal-body').innerHTML = 'iu thnguyen gất là nhìuuu lun đóoo<i class="fas fa-heart"></i> ';
